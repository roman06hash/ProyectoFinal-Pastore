...
formulario_edad.addEventListener("submit", (e) => {
    e.preventDefault();
    isNaN(edad_cliente) || edad_cliente > 10000 ? (mensaje_edad.style.display = "block", mensaje_mostrado = true) :
        (mensaje_edad.style.display = "none", window.location.href = "./welcome.html");

    !isNaN(edad_cliente) && edad_cliente >= 18 && edad_cliente <= 10000 ? window.location.href = "./welcome.html" : null;
